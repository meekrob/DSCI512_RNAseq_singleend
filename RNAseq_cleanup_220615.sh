...
# Description:
#
# This is a very basic pipeline to clean up the files generated from RNAseq_analyzer_220624.sh
#
...
# 
# Executed with:
# bash RNAseq_cleanup_220615.sh <metadata.txt>
################################################
